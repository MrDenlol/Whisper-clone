...
| **WhisperFlowClone assets** (`assets/app.ico`, `assets/app.svg`, `cmake/app.rc.in`) | MIT | This repository (`assets/`, `cmake/`) | Own icon resource embedded via generated `app.rc` (id 101) | Original project artwork, released under the project MIT `LICENSE`; no third-party icon is bundled |
